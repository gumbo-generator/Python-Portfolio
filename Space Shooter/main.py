...
def main():
    ...
    #define rect for spaceship (x,y,width,height)
    red = pygame.Rect(700, 300, SPACESHIP_WIDTH, SPACESHIP_HEIGHT) #Fixed: red = pygame.Rect(100, 450, SPACESHIP_HEIGHT, SPACESHIP_WIDTH)
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.KEYDOWN and len(yellow_bullets) < BULLET_MAX:
                if event.key == pygame.K_LCTRL:
                    bullet = pygame.Rect(yellow.x + yellow.width, yellow.y + yellow.height//2 - 2, 10, 5) #cannot contain floating point, use floor division // to round number to int 
